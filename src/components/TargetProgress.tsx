            ...
            <>
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="p-3 bg-green-500/10 rounded-lg">
                  <p className="text-xs text-muted-foreground mb-1">מענק הגעה ליעד חודשי</p>
          ...
          {calculations.quarterly.target ? (
            <>
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="p-3 bg-green-500/10 rounded-lg">
                  <p className="text-xs text-muted-foreground mb-1">מענק הגעה ליעד רבעוני</p>
                  ...
                  <div className="p-3 bg-muted/50 rounded-lg">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      {calculations.quarterly.totalPercentage >= 100 && (
                        <Badge variant="default" className="text-xs">
                          {calculations.quarterly.isCurrentPeriod ? "אתה אלוף" : "הושג!"}
                        </Badge>
                      )}
                    </div>
                  </div>
